...
// composite data type -------- (vector) ------ for 3 values inside in 1 structure
struct level {
    size_t rows = 0, columns = 0;
    char *data ; // pointer to an array //= nullptr
};
...
const size_t LEVEL_COUNT = 3; // constant variable to denote the array size (number of levels)
...
const int POINTS_FOR_DIAMOND = 30;
...
const float SCREEN_SCALE_DIVISOR = 85.3f; // The divisor was found through experimentation
...
const string PAUSE_TITLE  = "Press Esc to unpause the game";
...
enum game_state { // enumerator (integers) across vars in the game.
    MENU_STATE,
    GAME_STATE,
    PAUSED_STATE,
    VICTORY_STATE
...
game_state game_state = MENU_STATE; // variable , the inintial state in the game
